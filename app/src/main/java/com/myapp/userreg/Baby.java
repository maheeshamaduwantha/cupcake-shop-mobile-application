...
public class Baby extends AppCompatActivity {
    ...
    private int babyQuantity = 0;  // Variable to track quantity
    private static final double BABY_PRICE = 90.00;  // Price for one baby-themed cupcake
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1 = findViewById(R.id.logout); // Assuming you have the corresponding IDs in activity_baby.xml
        ...
        viewCartButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Baby.this, ViewCartActivity.class);
        ...
        btnAddToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String cupcakeName = "Baby Cupcake";
                CartItem cartItem = new CartItem(cupcakeName, babyQuantity, BABY_PRICE);
    ...
    private void updateQuantityAndPrice() {
        TextView tvQuantityBaby = findViewById(R.id.tvQuantityBaby);
        tvQuantityBaby.setText("Qty: " + babyQuantity);

        TextView tvTotalPriceBaby = findViewById(R.id.tvTotalPriceBaby);
        double totalPrice = babyQuantity * BABY_PRICE;
        tvTotalPriceBaby.setText("Total: Rs " + String.format("%.2f", totalPrice));
    }
}