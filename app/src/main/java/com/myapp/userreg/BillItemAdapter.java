...
public class BillItemAdapter extends ArrayAdapter<CartItem> {

    public BillItemAdapter(Context context, ArrayList<CartItem> cartItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        priceTextView.setText("Price: Rs " + String.format("%.2f", cartItem.getTotalPrice()));
